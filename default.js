window.onload = function() {
    ...
    function Apple(position){
        ...
        this.isOnSnake = function(snakeToCheck){
            ...
            for (var i = 0; i < snakeToCheck.body.length; i++) {
                if (this.position[0] === snakeToCheck.body[1][0] && this.position[1] === snakeToCheck.body[i][1]) {
                    isOnSnake = true;
                }   
            }
            return isOnSnake;
    ...
    function gameOver(){
        ...
        ctx.lineWidth = 5;
        ctx.strokeText('Game Over', 10 ,20);
        ctx.fillText('Game Over', 10 ,20);
        ctx.strokeText("Appuyer sur la touche Espace pour rejouer", 10, 40);
        ctx.fillText("Appuyer sur la touche Espace pour rejouer", 10, 40);
        ctx.restore();
    };
